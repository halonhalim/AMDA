            ...
            <div id="sidebar" class="sidebar responsive ace-save-state">
                ...
                <ul class="nav nav-list">                
                    ...
                    <li class="<?php if (in_array($breadcrumb, array("Article"))) echo 'active'; ?>"> 
                        <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-leaf"></i> <span class="menu-text">About home page</span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
                        <ul class="submenu">
                    ...
                    <li class="<?php if (in_array($breadcrumb, array("slider"))) echo 'active'; ?>"> 
                        <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-leaf"></i> <span class="menu-text">Our   Partner Image </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
                        <ul class="submenu">
                            <li class=""> <a href="<?php echo base_url() . 'slider/add'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Add Our   Partner Image  </a> <b class="arrow"></b> </li>
                            <li class=""> <a href="<?php echo base_url() . 'slider'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Manage Our   Partner Image </a> <b class="arrow"></b> </li>
                        </ul>
                    </li>  
                    <li class="<?php if (in_array($breadcrumb, array("aboutus"))) echo 'active'; ?>"> 
                        <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-leaf"></i> <span class="menu-text">About Us Menu</span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
                        <ul class="submenu">
                            <li class=""> <a href="<?php echo base_url() . 'aboutus/add'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Add about us  </a> <b class="arrow"></b> </li>
                            <li class=""> <a href="<?php echo base_url() . 'aboutus'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Manage about us </a> <b class="arrow"></b> </li>
                        </ul>
                    </li> 

                    <li class="<?php if (in_array($breadcrumb, array("coreprograms"))) echo 'active'; ?>"> 
                        <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-leaf"></i> <span class="menu-text"> Core Programs </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
                        <ul class="submenu">
                            <li class=""> <a href="<?php echo base_url() . 'coreprograms/add'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Add CorePrograms  </a> <b class="arrow"></b> </li>
                            <li class=""> <a href="<?php echo base_url() . 'coreprograms'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Manage Core programs </a> <b class="arrow"></b> </li>
                        </ul>
                    </li> 
                    <li class="<?php if (in_array($breadcrumb, array("membership"))) echo 'active'; ?>"> 
                        <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-leaf"></i> <span class="menu-text"> Membership </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
                        <ul class="submenu">
                            <li class=""> <a href="<?php echo base_url() . 'membership/add'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Add Membership  </a> <b class="arrow"></b> </li>
                            <li class=""> <a href="<?php echo base_url() . 'membership'; ?>"> <i class="menu-icon fa fa-caret-right"></i> Manage Membership </a> <b class="arrow"></b> </li>
                        </ul>
                    </li> 
