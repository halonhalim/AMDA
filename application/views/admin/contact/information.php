			...
			<div class="widget-body">
				<div class="widget-main">
					<form id="myForm" action="<?php echo base_url() . 'contact/save/' . md5($edit->id); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">   
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"> Head Office </label>   
							<div class="col-sm-9">
								<textarea name="headoffice" class="col-xs-10 col-sm-5" rows="3"><?php echo $edit->headoffice; ?></textarea>
							</div>
						</div>
                                                                                                                                <div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"> AMDA Headquaters</label>
							<div class="col-sm-9">
								<textarea name="amdaoffice" class="col-xs-10 col-sm-5" rows="3"><?php echo $edit->amdaoffice; ?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<span class="error"> Logo Size 556 x 180 </span>
								<br />
